...
def validate_cycle(cycle):
    ...
    required_flags = {
        ...
        "quantity_step_verified": cycle.get("quantity_step_verified") is True,
    ...
    if any(leg.get("quantity_step_verified") is not True for leg in legs):
        return False, "leg_quantity_step"
