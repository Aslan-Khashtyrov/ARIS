...
export const defaultState = {
  ...
  monthlyBudget: 0,
  providerBudgets: { openai: 0, anthropic: 0, openrouter: 0, kimi: 0, google: 0, mistral: 0, xai: 0 },
...
function sanitize(saved = {}) {
  ...
  return {
    ...
    providerBudgets: {
      ...
      google: finiteNonNegative(saved.providerBudgets?.google),
      mistral: finiteNonNegative(saved.providerBudgets?.mistral),
      xai: finiteNonNegative(saved.providerBudgets?.xai),
    },
