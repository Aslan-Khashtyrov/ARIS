export const agentRegistry = [
  ...
  { id: 'claude', name: 'Claude', roleKey: 'claude', priority: 3, mode: 'planned', enabled: true },
  { id: 'hermes', name: 'Hermes', roleKey: 'hermes', priority: 4, mode: 'configured', enabled: true },
];

export const routingPolicy = {
  coding: ['codex', 'gpt', 'claude', 'hermes'],
  reasoning: ['gpt', 'claude', 'codex', 'hermes'],
  review: ['claude', 'gpt', 'codex', 'hermes'],
  fallback: ['hermes'],
};
