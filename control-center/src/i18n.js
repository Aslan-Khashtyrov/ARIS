...
export const russianSource = {
  ...
  backupTitle: 'Backup', backupHint: 'Exports local data without secrets and always restores the bridge in a safe state.', backupExport: 'Export', backupImport: 'Restore', backupImported: 'Backup restored safely', backupInvalid: 'Backup file rejected', versionLabel: 'Shell version', versionValue: 'MVP 0.6 — command center',
