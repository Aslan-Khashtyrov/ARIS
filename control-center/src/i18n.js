...
export const russianSource = {
  ...
  readyMessage: 'Готов. Напиши задачу — Project One сам выберет доступного агента и вернёт его ответ.',
  inputPlaceholder: 'Напиши задачу одному ИИ...',
  send: 'Отправить', runCodex: 'Codex локально', runHermes: 'Hermes локально', runLiveAi: 'Запустить ИИ', liveAiRunning: 'ИИ отвечает…', runCouncil: 'Совет ИИ · до 2 вызовов', councilRunning: 'Совет проверяет…', clear: 'Очистить',
  ...
  homeAgents: 'ИИ-агенты', homeAgentsHint: 'реально готовы сейчас', homeAris: 'ARIS', homeSafe: 'БЕЗОПАСНО', homeTasks: 'Задачи', homeTasksHint: 'выполнено локально',
  ...
  nav: { home: 'Главная', chat: 'Чат', agents: 'Агенты', terminal: 'Терминал', services: 'Сервисы', aris: 'ARIS', missions: 'Поручения', tasks: 'Задачи', security: 'Защита', workspace: 'Среда', logs: 'Журнал', usage: 'Расходы', settings: 'Настройки' },
  ...
  agentStatuses: { ready: 'готов', noKey: 'нет ключа', bridgeOff: 'мост выключен', unavailable: 'недоступен', checking: 'проверка…' }, refreshAgents: 'Обновить статусы', enableBridgeHere: 'Включить локальный мост',
  screens: {
    ...
    workspace: { kicker: 'АВТОНОМНАЯ СРЕДА', title: 'Исполнитель', description: 'Локальный исполнитель Project One работает только внутри выданной области и проходит через Аргус.' },
  ...
  noLiveAgent: 'Сейчас нет доступного живого агента. Проверь экран «Агенты»: для Codex/Hermes нужен локальный мост, для остальных — защищённый ключ.',
  liveAiEmpty: 'Провайдер вернул пустой ответ.', logLocalAgentCompleted: agent => `Локальный агент ${agent} завершил задачу.`, logLocalAgentFailed: agent => `Локальный агент ${agent} завершился ошибкой.`, logLiveAiUnavailable: 'Живой ИИ не запущен: нет настроенного нативного провайдера.', logLiveAiCompleted: provider => `Живой запрос выполнен через ${provider}.`, logLiveAiFailed: provider => `Живой запрос через ${provider} завершился ошибкой.`, logAgentFallback: agent => `${agent} недоступен — пробуем следующий разрешённый канал.`, logCouncilCompleted: count => `Совет ИИ завершён: ${count} API-вызов(а).`, logCouncilFailed: 'Совет ИИ завершился ошибкой.',
  ...
  executorGuard: 'АРГУС КОНТРОЛИРУЕТ', executorReady: 'Контур автономной работы подготовлен', executorDescription: 'Как у локального агента: работа с файлами, тестами и сборкой — но без произвольного shell и без доступа к секретам.', executorScope: 'Рабочая область', executorMode: 'Режим', executorGuarded: 'Под контролем Аргуса', executorTakeover: 'Перехват управления', executorAlways: 'Всегда доступен', executorUnavailable: 'Недоступен', executorChannel: 'Канал выполнения', executorBridgeEnabled: 'Локальный bridge разрешён', executorBridgeDisabled: 'Ожидает безопасный bridge', executorAllowed: 'Разрешённые действия', executorNotice: 'Живое выполнение появится только через ограниченный локальный bridge. Произвольный shell, секреты и финансовые действия Аргус не пропустит.',
  ...
  en: {
    ...
    unifiedChat: 'UNIFIED CHAT', mainChat: 'Main chat', readyMessage: 'Ready. Send a task and Project One will choose an available agent and return its answer.',
    inputPlaceholder: 'Send a task to one AI...', send: 'Send', runCodex: 'Codex local', runHermes: 'Hermes local', runLiveAi: 'Run AI', liveAiRunning: 'AI is responding…', runCouncil: 'AI Council · up to 2 calls', councilRunning: 'Council is reviewing…', clear: 'Clear', router: 'ROUTER', agents: 'Agents',
    ...
    homeAgents: 'AI agents', homeAgentsHint: 'actually ready now', homeAris: 'ARIS', homeSafe: 'SAFE', homeTasks: 'Tasks', homeTasksHint: 'completed locally',
  ...
  nav: { home: 'Home', chat: 'Chat', agents: 'Agents', terminal: 'Terminal', services: 'Services', aris: 'ARIS', missions: 'Missions', tasks: 'Tasks', security: 'Security', workspace: 'Workspace', logs: 'Log', usage: 'Usage', settings: 'Settings' },
  ...
  modes: { configured: 'configured', planned: 'planned' }, nativeReady: 'key connected', agentStatuses: { ready: 'ready', noKey: 'no key', bridgeOff: 'bridge off', unavailable: 'unavailable', checking: 'checking…' }, refreshAgents: 'Refresh status', enableBridgeHere: 'Enable local bridge',
  screens: {
    ...
    workspace: { kicker: 'AUTONOMOUS WORKSPACE', title: 'Executor', description: 'Project One local executor stays inside its granted scope and is gated by Argus.' },
  ...
  noLiveAgent: 'No live agent is available right now. Check Agents: Codex/Hermes need the local bridge; other agents need a protected key.',
  liveAiEmpty: 'The provider returned an empty response.', logLocalAgentCompleted: agent => `Локальный агент ${agent} завершил задачу.`, logLocalAgentFailed: agent => `Локальный агент ${agent} завершился ошибкой.`, logLiveAiUnavailable: 'Live AI was not started: no configured native provider.', logLiveAiCompleted: provider => `Live request completed via ${provider}.`, logLiveAiFailed: provider => `Live request via ${provider} failed.`, logAgentFallback: agent => `${agent} unavailable — trying the next allowed channel.`, logCouncilCompleted: count => `AI Council completed with ${count} API call(s).`, logCouncilFailed: 'AI Council failed.',
  ...
  backupTitle: 'Backup', backupHint: 'Exports local data without secrets and always restores the bridge in a safe state.', backupExport: 'Export', backupImport: 'Restore', backupImported: 'Backup restored safely', backupInvalid: 'Backup file rejected', versionLabel: 'Shell version', versionValue: '2.4 — live agent status and bridge/API checks',
  ...
  executorGuard: 'ARGUS GATED', executorReady: 'Autonomous work contour is prepared', executorDescription: 'Local-agent style file, test and build work without arbitrary shell or secret access.', executorScope: 'Workspace', executorMode: 'Mode', executorGuarded: 'Guarded by Argus', executorTakeover: 'Take over control', executorAlways: 'Always available', executorUnavailable: 'Unavailable', executorChannel: 'Execution channel', executorBridgeEnabled: 'Local bridge allowed', executorBridgeDisabled: 'Waiting for secure bridge', executorAllowed: 'Allowed actions', executorNotice: 'Live execution will only use a constrained local bridge. Argus blocks arbitrary shell, secrets and financial actions.',
