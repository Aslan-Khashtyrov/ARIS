...
export const russianSource = {
  ...
  send: 'Подготовить', runLiveAi: 'Запустить ИИ', liveAiRunning: 'ИИ отвечает…', clear: 'Очистить',
  ...
  liveAiEmpty: 'Провайдер вернул пустой ответ.', logLiveAiUnavailable: 'Живой ИИ не запущен: нет настроенного нативного провайдера.', logLiveAiCompleted: provider => `Живой запрос выполнен через ${provider}.`, logLiveAiFailed: provider => `Живой запрос через ${provider} завершился ошибкой.`,
  ...
  en: {
    ...
    inputPlaceholder: 'Send a task to one AI...', send: 'Prepare', runLiveAi: 'Run AI', liveAiRunning: 'AI is responding…', clear: 'Clear', router: 'ROUTER', agents: 'Agents',
  ...
  liveAiEmpty: 'The provider returned an empty response.', logLiveAiUnavailable: 'Live AI was not started: no configured native provider.', logLiveAiCompleted: provider => `Live request completed via ${provider}.`, logLiveAiFailed: provider => `Live request via ${provider} failed.`,
  ...
  backupTitle: 'Backup', backupHint: 'Exports local data without secrets and always restores the bridge in a safe state.', backupExport: 'Export', backupImport: 'Restore', backupImported: 'Backup restored safely', backupInvalid: 'Backup file rejected', versionLabel: 'Shell version', versionValue: '1.4 — live native AI',
