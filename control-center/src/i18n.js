...
export const russianSource = {
  ...
  liveAiEmpty: 'Провайдер вернул пустой ответ.', logLocalAgentCompleted: agent => `Локальный агент ${agent} завершил задачу.`, logLocalAgentFailed: agent => `Локальный агент ${agent} завершился ошибкой.`, logLiveAiUnavailable: 'Живой ИИ не запущен: нет настроенного нативного провайдера.', logLiveAiCompleted: provider => `Живой запрос выполнен через ${provider}.`, logLiveAiFailed: provider => `Живой запрос через ${provider} завершился ошибкой.`, logCouncilCompleted: count => `Совет ИИ завершён: ${count} API-вызов(а).`, logCouncilFailed: 'Совет ИИ завершился ошибкой.',
