...
export const russianSource = {
  ...
  send: 'Подготовить', runCodex: 'Codex локально', runHermes: 'Hermes локально', runLiveAi: 'Запустить ИИ', liveAiRunning: 'ИИ отвечает…', runCouncil: 'Совет ИИ · до 2 вызовов', councilRunning: 'Совет проверяет…', clear: 'Очистить',
  ...
  en: {
    ...
    inputPlaceholder: 'Send a task to one AI...', send: 'Prepare', runCodex: 'Codex local', runHermes: 'Hermes local', runLiveAi: 'Run AI', liveAiRunning: 'AI is responding…', runCouncil: 'AI Council · up to 2 calls', councilRunning: 'Council is reviewing…', clear: 'Clear', router: 'ROUTER', agents: 'Agents',
